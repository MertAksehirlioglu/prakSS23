var _a;
import { reactive, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, version as version$1, unref, inject as inject$1, ref, watchEffect, watch, toRef, isRef, isShallow, isReactive, toRaw, nextTick, shallowRef, computed, isReadonly, onScopeDispose, effectScope, Fragment, toRefs, capitalize, warn, defineComponent as defineComponent$1, camelize, h, provide, createVNode, mergeProps, readonly, TransitionGroup, Transition, withDirectives, resolveDirective, vShow, Text, resolveDynamicComponent, Teleport, cloneVNode, createTextVNode, vModelText, onUpdated, Suspense, useSSRContext, onErrorCaptured, onServerPrefetch, defineAsyncComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-2943ed7d.js").then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-297ee9f1.js").then((r) => r.default || r));
